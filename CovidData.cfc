component restpath="/CovidData"  rest="true" {
    ...
    {
      // URL is: "https://localhost:8080/rest/metrics/CovidData/covidsums/{start_date}&{end_date}&{county_list}
    ...
    {
      // URL is: "https://localhost:8080/rest/metrics/CovidData/covid_heatmap_sums/{start_date}&{end_date}
      // Dates are in YYYY-MM-DD format, fips_list is in ('00000', '12345')
      // Leave fips_list as () to disable filtering
